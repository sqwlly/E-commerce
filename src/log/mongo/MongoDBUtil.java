...
public class MongoDBUtil {
    ...
    public static MongoClient initMongo() throws IOException{
        ...
        WriteConcern concern = new WriteConcern(
                Integer.valueOf(properties.getProperty("write")),
        ...
        Builder builder = MongoClientOptions
                .builder()
                .connectionsPerHost(
                        Integer.valueOf(properties.getProperty("connectionsPerHost")))
                .connectTimeout(
                        Integer.valueOf(properties.getProperty("connectTimeout")))
                .cursorFinalizerEnabled(
                        Boolean.valueOf(properties.getProperty("cursorFinalizerEnabled")))
                .maxWaitTime(
                        Integer.valueOf(properties.getProperty("maxWaitTime")))
                .threadsAllowedToBlockForConnectionMultiplier(
                        Integer.valueOf(properties.getProperty("threadsAllowedToBlockForConnectionMultiplier")))
                .socketTimeout(
                        Integer.valueOf(properties.getProperty("socketTimeout")))
                .socketKeepAlive(
                        Boolean.valueOf(properties.getProperty("socketKeepAlive")))
